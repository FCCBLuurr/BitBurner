...
export async function main(ns) {
    ...
    //errors when attempitng to purchase servers (if the server size returns infinity or is the same size as the current servers). 
        ...
        while ( ( i < ns.getPurchasedServerLimit() ) && (a == 0) ) {
            ...
            //If not enough money is available, this "if" statement will determine:
            //1. The ram size is invalid(ram size returns a server cost of Infinity)
            //2. The money needed to complete a purchase of 25 servers.
